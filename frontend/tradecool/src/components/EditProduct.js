  ...
  const sendFormData = () => {
    ...
    fetch(url, {
      ...
      data
        .json()
        .then(
          (data) => data.id !== undefined && props.setCurrentProductId(data.id)
        )
    );
      ...
      <Row>
        <Col md={8}>
          ...
          {product.id !== undefined && (
            <Image
              src={product.imagePath || "https://placehold.it/"}
              width="90%"
            />
          )}
        ...
        <Col md={4} className="mt-5">
          <Stack gap={3}>
            ...
            <Button variant="warning" onClick={currentProductToDefault}>
              Cancel
            </Button>{" "}
          </Stack>
        </Col>
